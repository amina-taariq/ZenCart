...
const NewsLetter = () => {
  return (
    <section className="max_padd_container py-12 xl:py-28 bg-white">
      <div className="mx-auto xl:w-[80%] flexCenter flex-col gap-y-8 w-full max-x-[666px]">
        ...
        <div className="flexBetween rounded-full ring-1 ring-slate-900/5 hover:ring-slate-900/15 bg-primary w-full max-w-[588px]">
          ...
          />
          <button className="bg-gray-800 text-white px-4 py-2 rounded-full border-none cursor-pointer transition duration-300 hover:bg-gray-600">Subscribe</button>
        </div>
      </div>
    </section>
  );
