      ...
      <div className="max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[744px] w-full">
        <div className="relative top-24 xs:top-32">
          ...
          <h2 className="h1 capitalize max-w-[40rem]">
            Elevate Your Look <span className="text-secondary">With Every Click.</span> Shop Today!
          </h2>
          <p className="my-5 max-w-[33rem]">
            Et ratione error voluptatem ipsum voluptatem tempore consequatur. Quos aspernatur suscipit distinctio vitae et. Repellendus repellendus beatae nihil rerum dolorem.…
          </p>
          {/* buttons */}
